...
-- 删除已有的前10卦数据，准备插入完整数据
DELETE FROM gua_data WHERE number <= 10;
...
-- 2. 坤为地
INSERT INTO gua_data (number, name, upper_trigram, lower_trigram, gua_ci, yao_ci) VALUES
(2, '坤为地', '坤', '坤', '元亨，利牝马之贞。君子有攸往，先迷后得主，利西南得朋，东北丧朋。安贞吉。',
'["初六：履霜，坚冰至。", "六二：直方大，不习无不利。", "六三：含章可贞。或从王事，无成有终。", "六四：括囊；无咎，无誉。", "六五：黄裳，元吉。", "上六：龙战于野，其血玄黄。"]');
...
-- 4. 山水蒙
INSERT INTO gua_data (number, name, upper_trigram, lower_trigram, gua_ci, yao_ci) VALUES
(4, '山水蒙', '艮', '坎', '亨。匪我求童蒙，童蒙求我。初噬告，再三渎，渎则不告。利贞。',
...
-- 6. 天水讼
INSERT INTO gua_data (number, name, upper_trigram, lower_trigram, gua_ci, yao_ci) VALUES
(6, '天水讼', '乾', '坎', '有孚，窒。惕中吉。终凶。利见大人，不利涉大川。',
'["初六：不永所事，小有言，终吉。", "九二：不克讼，归而逋，其邑人三百户，无眚。", "六三：食旧德，贞厉，终吉，或从王事，无成。", "九四：不克讼，复即命，渝安贞，吉。", "九五：讼，元吉。", "上九：或锡之鞶带，终朝三褫之。"]');
...
-- 12. 天地否
INSERT INTO gua_data (number, name, upper_trigram, lower_trigram, gua_ci, yao_ci) VALUES
(12, '天地否', '乾', '坤', '否之匪人，不利君子贞，大往小来。',
'["初六：拔茅茹，以其汇，贞吉亨。", "六二：包承。小人吉，大人否亨。", "六三：包羞。", "九四：有命无咎，畴离祉。", "九五：休否，大人吉。其亡其亡，系于苞桑。", "上九：倾否，先否后喜。"]');

-- 13. 天火同人
INSERT INTO gua_data (number, name, upper_trigram, lower_trigram, gua_ci, yao_ci) VALUES
(13, '天火同人', '乾', '离', '同人于野，亨。利涉大川，利君子贞。',
...
INSERT INTO gua_data (number, name, upper_trigram, lower_trigram, gua_ci, yao_ci) VALUES
(15, '地山谦', '坤', '艮', '亨，君子有终。',
'["初六：谦谦君子，用涉大川，吉。", "六二：鸣谦，贞吉。", "九三：劳谦君子，有终吉。", "六四：无不利，撝谦。", "六五：不富以其邻，利用侵伐，无不利。", "上六：鸣谦，利用行师，征邑国。"]');
...
-- 18. 山风蛊
INSERT INTO gua_data (number, name, upper_trigram, lower_trigram, gua_ci, yao_ci) VALUES
(18, '山风蛊', '艮', '巽', '元亨，利涉大川。先甲三日，后甲三日。',
'["初六：干父之蛊，有子，考无咎，厉终吉。", "九二：干母之蛊，不可贞。", "九三：干父之蛊，小有悔，无大咎。", "六四：裕父之蛊，往见吝。", "六五：干父之蛊，用誉。", "上九：不事王侯，高尚其事。"]');

-- 19. 地泽临
INSERT INTO gua_data (number, name, upper_trigram, lower_trigram, gua_ci, yao_ci) VALUES
(19, '地泽临', '坤', '兑', '元，亨，利，贞。至于八月有凶。',
'["初九：咸临，贞吉。", "九二：咸临，吉无不利。", "六三：甘临，无攸利。既忧之，无咎。", "六四：至临，无咎。", "六五：知临，大君之宜，吉。", "上六：敦临，吉无咎。"]');

-- 20. 风地观
INSERT INTO gua_data (number, name, upper_trigram, lower_trigram, gua_ci, yao_ci) VALUES
(20, '风地观', '巽', '坤', '盥而不荐，有孚颙若。',
'["初六：童观，小人无咎，君子吝。", "六二：闚观，利女贞。", "六三：观我生，进退。", "六四：观国之光，利用宾于王。", "九五：观我生，君子无咎。", "上九：观其生，君子无咎。"]');

-- 21. 火雷噬嗑
INSERT INTO gua_data (number, name, upper_trigram, lower_trigram, gua_ci, yao_ci) VALUES
(21, '火雷噬嗑', '离', '震', '亨。利用狱。',
'["初九：屦校灭趾，无咎。", "六二：噬肤灭鼻，无咎。", "六三：噬腊肉，遇毒；小吝，无咎。", "九四：噬乾胏，得金矢，利艰贞，吉。", "六五：噬乾肉，得黄金，贞厉，无咎。", "上九：何校灭耳，凶。"]');
...
-- 24. 地雷复
INSERT INTO gua_data (number, name, upper_trigram, lower_trigram, gua_ci, yao_ci) VALUES
(24, '地雷复', '坤', '震', '亨。出入无疾，朋来无咎。反复其道，七日来复，利有攸往。',
'["初九：不远复，无祗悔，元吉。", "六二：休复，吉。", "六三：频复，厉无咎。", "六四：中行独复。", "六五：敦复，无悔。", "上六：迷复，凶，有灾眚。用行师，终有大败，以其国君，凶；至于十年，不克征。"]');

-- 25. 天雷无妄
INSERT INTO gua_data (number, name, upper_trigram, lower_trigram, gua_ci, yao_ci) VALUES
(25, '天雷无妄', '乾', '震', '元，亨，利，贞。其匪正有眚，不利有攸往。',
'["初九：无妄，往吉。", "六二：不耕获，不菑畲，则利有攸往。", "六三：无妄之灾，或系之牛，行人之得，邑人之灾。", "九四：可贞，无咎。", "九五：无妄之疾，勿药有喜。", "上九：无妄，行有眚，无攸利。"]');

-- 26. 山天大畜
INSERT INTO gua_data (number, name, upper_trigram, lower_trigram, gua_ci, yao_ci) VALUES
(26, '山天大畜', '艮', '乾', '利贞，不家食吉，利涉大川。',
'["初九：有厉利已。", "九二：舆说辐。", "九三：良马逐，利艰贞。曰闲舆卫，利有攸往。", "六四：童牛之牿，元吉。", "六五：豮豕之牙，吉。", "上九：何天之衢，亨。"]');

-- 27. 山雷颐
INSERT INTO gua_data (number, name, upper_trigram, lower_trigram, gua_ci, yao_ci) VALUES
(27, '山雷颐', '艮', '震', '贞吉。观颐，自求口实。',
'["初九：舍尔灵龟，观我朵颐，凶。", "六二：颠颐，拂经，于丘颐，征凶。", "六三：拂颐，贞凶，十年勿用，无攸利。", "六四：颠颐吉，虎视眈眈，其欲逐逐，无咎。", "六五：拂经，居贞吉，不可涉大川。", "上九：由颐，厉吉，利涉大川。"]');

-- 28. 泽风大过
INSERT INTO gua_data (number, name, upper_trigram, lower_trigram, gua_ci, yao_ci) VALUES
(28, '泽风大过', '兑', '巽', '栋桡。利有攸往，亨。',
'["初六：藉用白茅，无咎。", "九二：枯杨生稊，老夫得其女妻，无不利。", "九三：栋桡，凶。", "九四：栋隆，吉；有它吝。", "九五：枯杨生华，老妇得士夫，无咎无誉。", "上六：过涉灭顶，凶，无咎。"]');

-- 29. 坎为水
INSERT INTO gua_data (number, name, upper_trigram, lower_trigram, gua_ci, yao_ci) VALUES
(29, '坎为水', '坎', '坎', '习坎，有孚，维心亨，行有尚。',
'["初六：习坎，入于坎窞，凶。", "九二：坎有险，求小得。", "六三：来之坎坎，险且枕，入于坎窞，勿用。", "六四：樽酒簋贰，用缶，纳约自牖，终无咎。", "九五：坎不盈，祗既平，无咎。", "上六：系用徽纆，寘于丛棘，三岁不得，凶。"]');

-- 30. 离为火
INSERT INTO gua_data (number, name, upper_trigram, lower_trigram, gua_ci, yao_ci) VALUES
(30, '离为火', '离', '离', '利贞，亨。畜牝牛，吉。',
'["初九：履错然，敬之无咎。", "六二：黄离，元吉。", "九三：日昃之离，不鼓缶而歌，则大耋之嗟，凶。", "九四：突如其来如，焚如，死如，弃如。", "六五：出涕沱若，戚嗟若，吉。", "上九：王用出征，有嘉折首，获匪其丑，无咎。"]');

-- 31. 泽山咸
INSERT INTO gua_data (number, name, upper_trigram, lower_trigram, gua_ci, yao_ci) VALUES
(31, '泽山咸', '兑', '艮', '亨，利贞，取女吉。',
'["初六：咸其拇。", "六二：咸其腓，凶，居吉。", "九三：咸其股，执其随，往吝。", "九四：贞吉悔亡，憧憧往来，朋从尔思。", "九五：咸其脢，无悔。", "上六：咸其辅，颊，舌。"]');

-- 32. 雷风恒
INSERT INTO gua_data (number, name, upper_trigram, lower_trigram, gua_ci, yao_ci) VALUES
(32, '雷风恒', '震', '巽', '亨，无咎，利贞，利有攸往。',
'["初六：浚恒，贞凶，无攸利。", "九二：悔亡。", "九三：不恒其德，或承之羞，贞吝。", "九四：田无禽。", "六五：恒其德，贞，妇人吉，夫子凶。", "上六：振恒，凶。"]');

-- 33. 天山遁
INSERT INTO gua_data (number, name, upper_trigram, lower_trigram, gua_ci, yao_ci) VALUES
(33, '天山遁', '乾', '艮', '亨，小利贞。',
'["初六：遁尾，厉，勿用有攸往。", "六二：执之用黄牛之革，莫之胜说。", "九三：系遁，有疾厉，畜臣妾吉。", "九四：好遁君子吉，小人否。", "九五：嘉遁，贞吉。", "上九：肥遁，无不利。"]');
...
-- 35. 火地晋
INSERT INTO gua_data (number, name, upper_trigram, lower_trigram, gua_ci, yao_ci) VALUES
(35, '火地晋', '离', '坤', '康侯用锡马蕃庶，昼日三接。',
'["初六：晋如，摧如，贞吉。罔孚，裕无咎。", "六二：晋如，愁如，贞吉。受兹介福，于其王母。", "六三：众允，悔亡。", "九四：晋如硕鼠，贞厉。", "六五：悔亡，失得勿恤，往吉无不利。", "上九：晋其角，维用伐邑，厉吉无咎，贞吝。"]');

-- 36. 地火明夷
INSERT INTO gua_data (number, name, upper_trigram, lower_trigram, gua_ci, yao_ci) VALUES
(36, '地火明夷', '坤', '离', '利艰贞。',
'["初九：明夷于飞，垂其翼。君子于行，三日不食，有攸往，主人有言。", "六二：明夷，夷于左股，用拯马壮，吉。", "九三：明夷于南狩，得其大首，不可疾贞。", "六四：入于左腹，获明夷之心，出于门庭。", "六五：箕子之明夷，利贞。", "上六：不明晦，初登于天，后入于地。"]');
...
-- 39. 水山蹇
INSERT INTO gua_data (number, name, upper_trigram, lower_trigram, gua_ci, yao_ci) VALUES
(39, '水山蹇', '坎', '艮', '利西南，不利东北；利见大人，贞吉。',
'["初六：往蹇，来誉。", "六二：王臣蹇蹇，匪躬之故。", "九三：往蹇来反。", "六四：往蹇来连。", "九五：大蹇朋来。", "上六：往蹇来硕，吉；利见大人。"]');

-- 40. 雷水解
INSERT INTO gua_data (number, name, upper_trigram, lower_trigram, gua_ci, yao_ci) VALUES
(40, '雷水解', '震', '坎', '利西南，无所往，其来复吉。有攸往，夙吉。',
'["初六：无咎。", "九二：田获三狐，得黄矢，贞吉。", "六三：负且乘，致寇至，贞吝。", "九四：解而拇，朋至斯孚。", "六五：君子维有解，吉；有孚于小人。", "上六：公用射隼于高墉之上，获之，无不利。"]');

-- 41. 山泽损
INSERT INTO gua_data (number, name, upper_trigram, lower_trigram, gua_ci, yao_ci) VALUES
(41, '山泽损', '艮', '兑', '有孚，元吉，无咎，可贞，利有攸往？曷之用，二簋可用享。',
'["初九：已事遄往，无咎，酌损之。", "九二：利贞，征凶，弗损益之。", "六三：三人行，则损一人；一人行，则得其友。", "六四：损其疾，使遄有喜，无咎。", "六五：或益之，十朋之龟弗克违，元吉。", "上九：弗损益之，无咎，贞吉，利有攸往，得臣无家。"]');

-- 42. 风雷益
INSERT INTO gua_data (number, name, upper_trigram, lower_trigram, gua_ci, yao_ci) VALUES
(42, '风雷益', '巽', '震', '利有攸往，利涉大川。',
'["初九：利用为大作，元吉，无咎。", "六二：或益之，十朋之龟弗克违，永贞吉。王用享于帝，吉。", "六三：益之用凶事，无咎。有孚中行，告公用圭。", "六四：中行，告公从。利用为依迁国。", "九五：有孚惠心，勿问元吉。有孚惠我德。", "上九：莫益之，或击之，立心勿恒，凶。"]');

-- 43. 泽天夬
INSERT INTO gua_data (number, name, upper_trigram, lower_trigram, gua_ci, yao_ci) VALUES
(43, '泽天夬', '兑', '乾', '扬于王庭，孚号，有厉，告自邑，不利即戎，利有攸往。',
...
-- 45. 泽地萃
INSERT INTO gua_data (number, name, upper_trigram, lower_trigram, gua_ci, yao_ci) VALUES
(45, '泽地萃', '兑', '坤', '亨。王假有庙，利见大人，亨，利贞。用大牲吉，利有攸往。',
'["初六：有孚不终，乃乱乃萃，若号一握为笑，勿恤，往无咎。", "六二：引吉，无咎，孚乃利用禴。", "六三：萃如，嗟如，无攸利，往无咎，小吝。", "九四：大吉，无咎。", "九五：萃有位，无咎。匪孚，元永贞，悔亡。", "上六：赍咨涕洟，无咎。"]');

-- 46. 地风升
INSERT INTO gua_data (number, name, upper_trigram, lower_trigram, gua_ci, yao_ci) VALUES
(46, '地风升', '坤', '巽', '元亨，用见大人，勿恤，南征吉。',
'["初六：允升，大吉。", "九二：孚乃利用禴，无咎。", "九三：升虚邑。", "六四：王用亨于岐山，吉无咎。", "六五：贞吉，升阶。", "上六：冥升，利于不息之贞。"]');

-- 47. 泽水困
INSERT INTO gua_data (number, name, upper_trigram, lower_trigram, gua_ci, yao_ci) VALUES
(47, '泽水困', '兑', '坎', '亨，贞，大人吉，无咎，有言不信。',
...
-- 48. 水风井
INSERT INTO gua_data (number, name, upper_trigram, lower_trigram, gua_ci, yao_ci) VALUES
(48, '水风井', '坎', '巽', '改邑不改井，无丧无得，往来井井。汔至亦未繘井，羸其瓶，凶。',
'["初六：井泥不食，旧井无禽。", "九二：井谷射鲋，瓮敝漏。", "九三：井渫不食，为我心恻，可用汲，王明，并受其福。", "六四：井甃，无咎。", "九五：井洌，寒泉食。", "上六：井收勿幕，有孚无吉。"]');

-- 49. 泽火革
INSERT INTO gua_data (number, name, upper_trigram, lower_trigram, gua_ci, yao_ci) VALUES
(49, '泽火革', '兑', '离', '己日乃孚，元亨利贞，悔亡。',
...
-- 55. 雷火丰
INSERT INTO gua_data (number, name, upper_trigram, lower_trigram, gua_ci, yao_ci) VALUES
(55, '雷火丰', '震', '离', '亨。王假之，勿忧，宜日中。',
'["初九：遇其配主，虽旬无咎，往有尚。", "六二：丰其蔀，日中见斗，往得疑疾，有孚发若，吉。", "九三：丰其沛，日中见沫，折其右肱，无咎。", "九四：丰其蔀，日中见斗，遇其夷主，吉。", "六五：来章，有庆誉，吉。", "上六：丰其屋，蔀其家，闚其户，阒其无人，三岁不觌，凶。"]');

-- 56. 火山旅
INSERT INTO gua_data (number, name, upper_trigram, lower_trigram, gua_ci, yao_ci) VALUES
(56, '火山旅', '离', '艮', '小亨，旅贞吉。',
'["初六：旅琐琐，斯其所取灾。", "六二：旅即次，怀其资，得童仆贞。", "九三：旅焚其次，丧其童仆，贞厉。", "九四：旅于处，得其资斧，我心不快。", "六五：射雉一矢亡，终以誉命。", "上九：鸟焚其巢，旅人先笑后号咷。丧牛于易，凶。"]');

-- 57. 巽为风
INSERT INTO gua_data (number, name, upper_trigram, lower_trigram, gua_ci, yao_ci) VALUES
(57, '巽为风', '巽', '巽', '小亨，利有攸往，利见大人。',
